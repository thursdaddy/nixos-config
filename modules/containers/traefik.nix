_: {
  flake.modules.nixos.containers =
    ...
    let
      ...
      fqdn = "${cfg.subdomain}.${rootDomainName}";
      cfg = config.mine.containers.${name};
      regex_rootDomain = builtins.replaceStrings [ "." ] [ "\\." ] "${rootDomainName}";
      ...
      config = lib.mkIf cfg.enable {
        virtualisation.oci-containers.containers."${name}" = {
          ...
          labels = {
            ...
            "traefik.http.routers.${name}.tls.domains[0].main" = "${rootDomainName}";
            "traefik.http.routers.${name}.tls.domains[0].sans" = "*.${rootDomainName}";
        ...
        sops = {
          secrets = {
            ...
            "aws/traefik/AWS_HOSTED_ZONE_ID" = lib.mkIf cfg.awsEnvKeys { };
        ...
        environment.etc."traefik/providers/placeholder".text = "";
